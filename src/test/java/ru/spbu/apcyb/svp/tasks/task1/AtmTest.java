...
class AtmTest {
  ...
  void testComputeCombinationsSingleDenomination() {
    ...
    List<List<Integer>> result = computeCombinations(sum, numbers);
  ...
  void testComputeCombinationsZeroAmount() {
    ...
    assertThrows(IllegalArgumentException.class, () -> computeCombinations(sum, numbers));
  }
  ...
  @Test
  void testComputeCombinationsNegativeDenominations() {
    int sum = 5;
  ...
  void testComputeCombinationsNullDenominations() {
    ...
    assertThrows(NullPointerException.class, () -> computeCombinations(sum, numbers));
  }
